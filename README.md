...
3. Github challenge #3: Clone the Doug Lesson Plan repository (https://github.com/theAgingApprentice/DougLessonPlan) under theAgingApprentice’s Github account to your own Github reposiitory (https://github.com/BlacksmithThree). 
